function [flow_accumulation, ws_dem] = recursiveFlowAccumulationWS(flow_accumulation, flow_direction, ws_dem, cell)
...
for x = -1 : 1 % loop through neighboring cells
    for y = -1 : 1
        ...
        if flow_direction(r+y, c+x) == mod(cart2pol(x, y)-pi, 2*pi)
            ...
            [flow_accumulation, ws_dem] = recursiveFlowAccumulationWS(flow_accumulation, flow_direction, ws_dem, neighbor_cell);
