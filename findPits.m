...
disp(strcat('IDing the pits, and ALL_INDICES of pit_data took: ', num2str(pits_ID_time)))
...
for list_idx = 1 : numel(list_of_pit_indices)
    ...
    current_pit{DRAINAGE_RATE} = 0; %net_flow_accumulation(cur_pit_cell)
    ...
    current_pit{SPILLOVER_TIME} = findSpilloverTime(cellsize, intensity, current_pit{AREA_CELL_COUNT}, current_pit{VOLUME}, current_pit{DRAINAGE_RATE});
